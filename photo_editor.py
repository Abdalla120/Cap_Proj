...
class ModelTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.map_btn = QPushButton("Heat Maps")
        self.map_btn.setFixedWidth(90)
        self.map_btn.clicked.connect(self.on_map)
        ...
        map_layout.setAlignment(Qt.AlignLeft)
    ...
    def on_apply(self):
        logger.debug("apply")
        cmd = "cmd /k run_single.sh " + img_path + " L-CC"
        os.system(cmd)
